...
```
git clone https://github.com/oanhnn/phaser-es6-boilerplate.git
```
...
See [gulpfile.md](https://github.com/oanhnn/phaser-es6-boilerplate/blob/master/gulpfile.md)
...
Please report any bugs or add requests on [Github Issues](https://github.com/oanhnn/phaser-es6-boilerplate/issues).

## About this

This is customize boilerplate from [Daniel Belohlavek](http://twitter.com/dbhvk)'s [boilerplate](https://github.com/belohlavek/phaser-es6-boilerplate)
